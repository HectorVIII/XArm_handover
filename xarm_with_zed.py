...
# Poses (mm/deg)
P0 = dict(x=629.3, y=-29.1, z=36.6, roll=178.2, pitch=-0.8, yaw=6.8)    # above tool, ready to grip, avoid shelf collision
...
R_cb = np.array( [
    [0.14401772498071977, -0.37152242415526016, 0.9171859044060677], 
    [0.9895153863357063, 0.06424884057811589, -0.1293498615742083], 
    [-0.010871756816483053, 0.9261982373305225, 0.3768801269230795]] )
